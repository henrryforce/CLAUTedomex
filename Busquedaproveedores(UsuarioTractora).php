...
<body>
 ...
 <section class="main-body pt-5 float-start industry-pages">
        ...
        <div class="container mt-1">
            ...
            <?php
            $idModal = 'modal1' ;
            $htmlDiv = "<div class=\"col-sm-6 col-xl-3 mb-3\" id=\"modal_generada\">
            <div class=\"card card-span shadow py-4 h-100 border-top border-4 border-primary\">
              <div class=\"card-body\">
                <div class=\"text-center\"><img src=\"php/archivosUpload/logos/0c6wskhiz5.png\" width=\"220px\" alt=\"...\">
                  <h5 class=\"my-3\">Modal new</h5>
                  
                </div>
              </div>
              <div class=\"border-top bg-white text-center pt-3 pb-0\">
                  <a class=\"btn btn-primary\" href=\"#\"data-bs-toggle=\"modal\" data-bs-target=\"#$idModal\">Saber más</a>
        ...
        <div class="row h-100">
            ...
            <div class="col-sm-6 col-xl-3 mb-3">
              ...
              <div class=\"modal-body\">
                  ...
                  <div class=\"card\">
                      <!-- TITULO DE LA CARD -->
                      <h5 class=\"card-header\">Modal generada</h5>
